...
import { ChangeCheckboxFieldActionPayload, ChangeInputFieldActionPayload, ChangeRadioFieldActionPayload, EditFormPageSchema } from "../types/editPage"
...
const initialState: EditFormPageSchema = {
  isLoading: false
};
...
export const { reducer: editFormPageReducer } = editFormSlice
export const { actions: editFormPageActions } = editFormSlice
